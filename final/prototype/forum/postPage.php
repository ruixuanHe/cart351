...
if(isset($_SESSION['isLogin'])){
 ...
 if($_SERVER['REQUEST_METHOD'] == 'POST')
 {
   ...
   $insertStatement =  "INSERT INTO forum (userEmail, currentUser,topic,content,createDate,createTime) VALUES ('" . $userEmail . "', '" . $currentUser . "', '" . $topic . "', '" . $content . "', '" . $createDate . "', '" . $createTime . "')";
